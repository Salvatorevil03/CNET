...
def process(input_image, prompt, a_prompt, n_prompt, target_word, num_samples, image_resolution, ddim_steps, guess_mode, strength, scale, seed, eta):
...
with block:
    with gr.Row(): gr.Markdown("## Control Stable Diffusion with Scribble Maps & Attention Viz")
    with gr.Row():
        with gr.Column():
